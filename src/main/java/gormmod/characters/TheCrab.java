...
import static gormmod.GormMod.characterPath;
import static gormmod.GormMod.makeID;

public class TheCrab extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheCrab"); //This should match whatever you have in the CharacterStrings.json file
